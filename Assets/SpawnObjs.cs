...
// #endif
    ...
    public void StartSpawn()
    {
        ...
        for (int itemIndex = 0; itemIndex < SpawnObjects.Count; itemIndex++) {

            GameObject prefab = SpawnObjects[itemIndex];
            int spawnCount = SpawnAmounts[itemIndex];
            ...
            for (int i = 0; i < spawnCount; ++i)
            {
                for (int j = 0; j < MaxIterations; ++j)
                {
                    ...
                    if (SpawnLocations == SpawnLocation.Floating)
                    {
                        ...
                        {
                            UnityEngine.Debug.Log("breaking early");
                            break;
                        }
                    ...
                    if (prefab.gameObject.scene.path == null)
                    {
